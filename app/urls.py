...
from .views.language import LanguagePageView, LanguagesPageView, CreateLanguageView
from .views.BookInstance import CreateBookInstanceView, BookInstancePageView,BookInstancesPageView
...
urlpatterns = [
    ...
    path('catalog/languages/', LanguagesPageView.as_view(), name="languages"),
    path('catalog/language/<int:pk>/', LanguagePageView.as_view(), name='language'),
    path('catalog/language/add/', CreateLanguageView.as_view(), name='add language'),

    path('catalog/book-instances/', BookInstancesPageView.as_view(), name="book-instances"),
    path('catalog/book-instance/<int:pk>/', BookInstancePageView.as_view(), name='book-instance'),
    path('catalog/book-instance/add/', CreateBookInstanceView.as_view(), name='add book-instance'),
]
